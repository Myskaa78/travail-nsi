...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    ...
    <body>
      ...
      <form name="inscription" method="post" action="index.php">
        ...
        Entre le nom de l'auteur : <input="text" name="auteur"/><br/>
        L'annéee de publication : <input="text" name="annee"/><br/>
        Le nombre de tme : <input="text" name="nombre_tome"/><br/>
        Le titre : <input="text" name="titre"/><br/>
        <h2>Commentaire</h2>
